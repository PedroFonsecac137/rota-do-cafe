...
game.addEventListener('hud',e=>{$('#score').textContent=Math.round(e.detail.score).toLocaleString('pt-BR');$('#combo').textContent=e.detail.combo>=5?'x2':`${e.detail.combo}/5`;$('#time').textContent=Math.ceil(e.detail.time);});
