...
export class Game extends EventTarget{
 ...
 loop(n){const dt=Math.min(.034,(n-this.last)/1000);this.last=n;this.t+=dt;if(this.mode==='playing'){this.update(dt);if(this.vy===0)this.jumps=0;if(this.elapsed>=this.nextStageAt){this.spawn();this.nextStageAt+=this.stageStep<12?1.15:.95;}this.speed*=1.18;}this.draw();requestAnimationFrame(x=>this.loop(x));}
