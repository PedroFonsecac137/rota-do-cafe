const W=480,H=270,G=220,DURATION=30,START_SPEED=164,SPEED_GAIN=4.8,C={sky:'#79cde7',mist:'#dff3e7',hill:'#71a865',hill2:'#4f914f',grass:'#72ad47',leaf:'#246340',leaf2:'#347d4b',soil:'#d18447',cream:'#ffe1a0',yellow:'#efbc3e',red:'#d84937',green:'#205a42',skin:'#bd7950',brown:'#704128',gray:'#737a72',dark:'#183c2c'};
...
export class Game extends EventTarget{
 ...
 loop(n){const dt=Math.min(.034,(n-this.last)/1000);this.last=n;this.t+=dt;if(this.mode==='playing'){this.update(dt);if(this.vy===0)this.jumps=0;if(this.elapsed>=this.nextStageAt){this.spawn();this.nextStageAt+=this.stageStep<12?1.06:.88;}this.speed*=1.18;}this.draw();requestAnimationFrame(x=>this.loop(x));}
 ...
 spawn(){
  ...
  pattern.forEach((type,i)=>{
   ...
   this.objects.push({type,x:500+i*62,y,w,h,good:false,points:type==='borer'||type==='bird'||type==='bees'?-100:-70});
  });
 }
