const W=480,H=270,G=220,DURATION=30,START_SPEED=120,SPEED_GAIN=1.8,C={sky:'#79cde7',mist:'#dff3e7',hill:'#71a865',hill2:'#4f914f',grass:'#72ad47',leaf:'#246340',leaf2:'#347d4b',soil:'#d18447',cream:'#ffe1a0',yellow:'#efbc3e',red:'#d84937',green:'#205a42',skin:'#bd7950',brown:'#704128',gray:'#737a72',dark:'#183c2c'};
...
export class Game extends EventTarget{
 ...
 start(){Object.assign(this,{mode:'playing',score:0,combo:0,maxCombo:0,collected:0,mistakes:0,time:DURATION,elapsed:0,speed:START_SPEED,next:1,y:0,vy:0,land:0,slide:0,slideHold:false,inv:0,rush:false,birdScheduled:false,dying:false,deathTimer:0,deathType:'',runStep:-1,objects:[],particles:[]});this.emit('hud');}
