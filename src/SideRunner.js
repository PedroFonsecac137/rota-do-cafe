...
export class Game extends EventTarget{
 ...
 fence(o){if(!this.fenceArt){this.fenceArt=new Image();this.fenceArt.src='/assets/items/capri/fence-capri-v3.png';}const g=this.g,x=o.x,y=G-40;if(this.fenceArt.complete&&this.fenceArt.naturalWidth){g.save();g.imageSmoothingEnabled=true;g.drawImage(this.fenceArt,x-12,y,76,40);g.restore();return;}this.rect(x-5,G-38,62,38,'#9b6336');}
 holeClean(o){
